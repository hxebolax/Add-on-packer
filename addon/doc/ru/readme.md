...
Это дополнение может быть запущено из меню Инструменты / Утилиты для дополнений NVDA.

Дополнение не имеет назначенного сочетания клавиш для быстрого использования.

Вы можете добавить жест в меню Настройки / Входные жесты... и найти Утилита для дополнений NVDA.
